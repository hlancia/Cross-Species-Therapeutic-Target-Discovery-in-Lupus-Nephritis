...
> **Note:** The exact ordering should reflect the consensus scoring methodology used in the repository. If the final evidence scores are updated, this table should be revised to remain consistent with the final figures.
...
The computational framework is readily adaptable to therapeutic target discovery in other autoimmune and inflammatory diseases.

---

## Future Directions

Planned extensions of this framework include:
